...
- 質問
  - ドメインモデルはテーブルに対応するのか？
    - 複数テーブルに分かれることもあれば1対1になることもある。切り離して考える。
...
|飲み会|Party||
|参加者|Member||
|支払い区分|PaymentCategory||
|請求金額|billingAmount||
|支払金額|paymentAmount||
|支払割合|paymentRate||
|参加者種別|MemberType|幹事？参加者？|
|お金|money|あるとうれしいもの|
|レシート|receipt|割り勘の対象となるその明細|
|性別|male,female|女性は安くする|
|年齢|age|年齢が高いと多く払う|
|忖度|sontaku|えー。おれがはらうの？的ななにか|
|飲み会の雰囲気|type|雰囲気がわるかったら、割り勘する気が無くなるから。幹事が払え。|
|ぺいぺい|paypay|既に割り勘ツールがある|
|トイレ|toilet|割り勘のタイミングでトイレに逃げ込むことができる|
|酔いの深さ|deep-drunk|酔っ払っている人に多く払わせることができる|
|新入社員|newcommer|新入社員は無料なので、割り勘人数には含めない|
|取締役フラグ|chief-flag|その中に取締役がいれば、総取り。|
|お店|shop|お金を払う先|
|稟議|approval-paper|承認済み稟議の金額までは、その会社が払うことになる|
|開催日時|partyDays  |  |
|開催場所||店の詳細|
|参加人数|  |  |
